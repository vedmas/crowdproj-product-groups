...
data class ProductGroupContext(
    ...
    var adValidating: ProductGroup = ProductGroup(),
    var adFilterValidating: ProductGroupFilter = ProductGroupFilter(),

    var adValidated: ProductGroup = ProductGroup(),
    var adFilterValidated: ProductGroupFilter = ProductGroupFilter(),
